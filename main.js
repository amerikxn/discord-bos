...
mongoose.connect(config.mongodb, {useNewUrlParser: true, useUnifiedTopology: true}).then(c => console.log(`Logged in as MongoDB`)).catch(err => console.error(`Failed to login to the MongoDB!`));
